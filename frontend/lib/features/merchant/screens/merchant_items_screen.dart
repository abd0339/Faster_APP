          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Text(
                  'Stock tip: use -1 for unlimited, or set a number to track inventory',
                  style: AppTextStyles.caption,
                ),
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Item will auto-unsnooze when time expires',
              style: AppTextStyles.bodyMedium,
            ),
            const SizedBox(height: 20),
