...
@Table(name = "orders", indexes = {
                ...
                @Index(name = "idx_order_tracking", columnList = "tracking_code"),
...
public class Order {
        ...
        // Nullable — MOBILITY orders have no merchant
        ...
        @Builder.Default
        @Column(name = "driver_pays_merchant", precision = 10, scale = 2)
        ...
        @Builder.Default
        @Column(name = "merchant_commission", precision = 10, scale = 2)
